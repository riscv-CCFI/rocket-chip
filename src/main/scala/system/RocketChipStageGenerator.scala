...
import freechips.rocketchipRT.stage.RocketChipCli
...
private[freechips] final class RocketChiselStage extends ChiselStage {
  ...
  override val targets = Seq(
    ...
    Dependency[freechips.rocketchipRT.stage.phases.GenerateROMs],
...
class RocketChipStage extends Stage with PreservesAll[Phase] {
  ...
  val targets: Seq[PhaseDependency] = Seq(
    Dependency[freechips.rocketchipRT.stage.phases.Checks],
    Dependency[freechips.rocketchipRT.stage.phases.TransformAnnotations],
    Dependency[freechips.rocketchipRT.stage.phases.PreElaboration],
    Dependency[RocketChiselStage],
    Dependency[freechips.rocketchipRT.stage.phases.GenerateFirrtlAnnos],
    Dependency[freechips.rocketchipRT.stage.phases.AddDefaultTests],
    Dependency[freechips.rocketchipRT.stage.phases.GenerateTestSuiteMakefrags],
    Dependency[freechips.rocketchipRT.stage.phases.GenerateArtefacts]
  )
